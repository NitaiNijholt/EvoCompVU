...
class Evolve:
    ...
    def run(self):
        ...
        for i in range(ini_g, self.generations + 1):
            ...
            self.generation_data['generation'].append(i)
            self.generation_data['best_fitness'].append(self.fitness_population[self.best])
            self.generation_data['mean_fitness'].append(self.mean)
            self.generation_data['std_deviation'].append(self.std)
